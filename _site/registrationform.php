<?php
$my_email = "registration@nbconference.com";
$errors = array();
...
Thank you for registering for ICNB 2016. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@nbconference.com. You can find the copyright form here: www.nbconference.com/papers. Please note that failing to do so may result in an unsuccessful process of your registration.
...
$your_subject = "Your Registration Details for ICNB'16";

$your_headers = "From: ICNB'16 <" . $my_email . ">";
...
<div id="content">
  ...
  <header>
	...
	<div class="cbp-af-inner">
        ...
        <div class="bg">
          <h1>International Conference on<br> Nanobiotechnology (ICNB'16)</h1>
 ...
 <div class="unit unit-s-3-4 unit-m-3-4 unit-l-3-4">
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">ICNB 2016:</p>
      <p class="body">ICNB 2016 will  be held in Ottawa, Canada on April 1 - 2, 2016.</p>
    </div>          
    <div>
      <h2 class="title">2</h2>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  <div class="unit-spacer content">
	...
	<p class="body">We are looking forward to seeing you at ICNB'16!</p>
  </div>
</div>
...
<footer id="contact">
	...
	<div class="unit-spacer">
	<p class="body">For questions or comments regarding ICNB'16, please fill out the form below:</p>
