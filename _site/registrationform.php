...
<p class="body" style="text-align:center!important; color: #FFF!important;">ICNB'17 is part of the <b>2<sup>nd</sup> World Congress on Recent Advances in Nanotechnology (RAN'17)</b>.<br>For more information about the congress, please visit the website here: <a href="http://rancongress.com/" class="body-link">www.rancongress.com</a>.</p>
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      ...
      <p class="body">ICNB 2017 will  be held in Barcelona, Spain on April 5 - 6, 2017 at the Alimara Hotel Barcelona.</p>
...
<p class="bold">Poster Board Dimensions:</p>
  ...
  <div>
      ...
      <p class="body">ICNB attracts a wide range of researchers in the field of nanobiotechnology. As a prominent company in the field of nanobiotechnology, we would like to offer you an exhibit at ICNB. Please visit <a href="../events" class="body-link">Events</a> for more information.</p>
    </div>
  </div>
    </div>
  </div>
